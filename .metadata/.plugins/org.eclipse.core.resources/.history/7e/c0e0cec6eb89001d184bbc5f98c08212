...
int main(void)
{
	...
	Gpio_pd.gPIO_pinConfig.pin_number = GPIO_PIN_NO_14; // 4 // 2:54:00;
	Gpio_pd.gPIO_pinConfig.pin_otype = GPIO_OTYPE_OD;
	...
	**/
	...
	gpio_writeto_output_pin(GPIOD,GPIO_PIN_NO_12,GPIO_PIN_SET);
